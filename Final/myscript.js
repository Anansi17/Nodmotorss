...
// r.value = "";
 ...
 // r4.value = "";
  ...
  var y = document.getElementById("thnk2");
...
x.style.display = "flex"
y.style.display = "block";
document.getElementById("usrform2").style.display="none";
}
              ...
              i.style.display = "none";
                ...
                document.getElementById("usrform").style.display="flex";
                    var x = document.getElementById("idform");
                      ...
                      var k = document.getElementById("input1-2");
                      var k2 = document.getElementById("input2-2");
                      var k3 = document.getElementById("input3-2");
                      var k4 = document.getElementById("input4-2");
                   
                      document.getElementById("sbmt2").onclick = handleSubmitClick2;
                      
                      function canSubmitClick2() {
                          return !(k.value == "" || k2.value == "" || k3.value == "" || k4.value == "")
                      }
                      
                      function handleSubmitClick2(j) {
                          if( !canSubmitClick2() ) {
                              return;
                          }
